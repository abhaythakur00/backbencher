    ...
    <div className="big-con">
      ...
      <div className="About-container">
        ...
        <div className="seven-page">
          ...
          <div className="hading-5">
            <h1>Innovative Learning Solutions</h1>
            <p>
              Develop cutting-edge learning solutions that cater to different
              learning styles and preferences.
              <br />
              Incorporate interactive elements, gamification, and adaptive
              learning techniques to engage students effectively.
              <br />
              software development programmes directly to learners and via our
              education partners in further education.
              <br />
              Code Institute also partners with governments worldwide on
              training initiatives related to employment
              <br />
              diversity, and equality in the tech sector.
            </p>
          </div>
        </div>
        {/* EIGHT PAGE */}
        <div className="eight-page">
          <div className="hading-6"></div>
        ...
        <div className="nine-page">
          ...
          <div className="hading-7"></div>
        </div>
        {/* TEN PAGE */}
        <div className="ten-page">
          <div className="manegment-person">
            <div className="manegment-person-photo">
              <img src={team} />
            </div>
            <div className="manegment-person-photo">
              <img src={team} />
            ...
            <div className="manegment-person-photo-2">
              <img src={team} />
            </div>
            <div className="manegment-person-photo-2">
              <img src={team} />
        ...
        <div className="Eleven-page">
          ...
          <div className=" Social-Initiatives-image">
            <img src={team} />
          </div>
        </div>
